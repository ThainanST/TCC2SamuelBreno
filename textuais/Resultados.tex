...
Nesta seção será feita um resumo com os principais resultados técnicos obtidos através da simulação das usinas de $10$kW de eixo fixo e móvel.
A \autoref{tab:rt10} mostra os resultados da simulação:
...
Fixo & $14.523$ &  $1.376,15$ & $67,60$\% \\ \hline
\textit{Tracker} & $17.746$ &  $1.698,48$ & $69,73$\% \\ \hline

\end{tabular}
\caption{Resultados técnicos das Usinas de $10$kW}
\label{tab:rt10}
\end{table}
...
Nesta seção será feita um resumo com os principais resultados financeiros obtidos através da simulação das usinas de $10$kW de eixo fixo e móvel.
A \autoref{tab:rf10} mostra os resultados da simulação:
...
Fixo & $0,2198$ & $7$ anos, $10$ meses & $11,91$ & $14,26$ \\ \hline
\textit{Tracker} & $0,2331$ & $8$ anos  & $11,94$ & $14,52$ \\ \hline

\end{tabular}
\caption{Resultados Financeiros das Usinas de 10kW}
\label{tab:rf10}
\end{table}
...
\subsection{Resultados técnicos}
Nesta seção será feita um resumo com os principais resultados técnicos obtidos através da simulação das usinas de $50$kW de eixo fixo e móvel.
A \autoref{tab:rt50} mostra os resultados da simulação:
...
\hline
\textbf{Sistema} & \textbf{Energia anual [kWh]} & \textbf{Rendimento[kWh/kWp]} & \textbf{Eficiência[\%]} \\ \hline
Fixo & $72.251$ & $1.430,18$ &  $70,25$ \\ \hline
\textbf{Tracker} & $88.295$ &  $1.751,08$ & $71,89$  \\ \hline

\end{tabular}
\caption{Resultados técnicos das Usinas de $50$kW}
\label{tab:rt50}
\end{table}

Nos SFCR de $50$ kW, a diferença técnica mantém-se proporcional. O sistema fixo injeta cerca de $72.251$ kWh/ano, ao passo que o \textit{tracker} atinge $88.295$ kWh/ano, representando também um ganho de aproximadamente $22$\%. O rendimento específico sobe de $1.430$ kWh/kWp para $1.751$ kWh/kWp, evidenciando melhor aproveitamento do recurso solar. Já a eficiência, embora próxima, é ligeiramente superior no \textit{tracker} ($71,9$\%) em comparação ao fixo (70,3\%).

\subsection{Resultados Financeiros}
Nesta seção será feita um resumo com os principais resultados financeiros obtidos através da simulação das usinas de $50$kW de eixo fixo e móvel.
A \autoref{tab:rf50} mostra os resultados da simulação:
...
\hline
\textbf{Sistema} & \textbf{Custo de geração[R\$/kWh]} & \textbf{\textit{PayBack}[anos]]} & \textbf{\ac{TIR}[\%]} & \textbf{\ac{ROI}[\%]} \\ \hline
Fixo & $0,1961$ & $7$ anos, $3$ meses & $13,07$ & $15,30$ \\ \hline
\textbf{Tracker} & $0,234$ &  $8$ anos, $4$ meses & $11,00$ & $13,95$ \\ \hline

\end{tabular}
\caption{Resultados Financeiros das Usinas de 50kW}
\label{tab:rf50}
\end{table}
...
\subsection{Resultados técnicos}
Nesta seção será feita um resumo com os principais resultados técnicos obtidos através da simulação das usinas de $100$kW de eixo fixo e móvel.
A \autoref{tab:rt100} mostra os resultados da simulação:
\begin{table}[h!]
\centering
\begin{tabular}{|c|c|c|c|}
\hline
\textbf{Sistema} & \textbf{Energia anual [kWh]} & \textbf{Rendimento[kWh/kWp]} & \textbf{Eficiência[\%]} \\ \hline
Fixo & $144.501$ & $1.430,18$ & $70,30$ \\ \hline
\textit{Tracker} & $176.590$ & $1.751,08$  & $71,89$  \\ \hline

\end{tabular}
\caption{Resultados técnicos das Usinas de $100$kW}
\label{tab:rt100}
\end{table}
...
Nesta seção será feita um resumo com os principais resultados financeiros obtidos através da simulação das usinas de $100$kW de eixo fixo e móvel.
A \autoref{tab:rf100} mostra os resultados da simulação:
...
\end{tabular}
\caption{Resultados Financeiros das Usinas de $100$kW}
\label{tab:rf100}
\end{table}
...
\subsection{Resultados técnicos}
Nesta seção será feita um resumo com os principais resultados técnicos obtidos através da simulação das usinas de $300$kW de eixo fixo e móvel.
A \autoref{tab:rt300} mostra os resultados da simulação:
\begin{table}[h!]
\centering
\begin{tabular}{|c|c|c|c|}
\hline
\textbf{Sistema} & \textbf{Energia anual [kWh]} & \textbf{Rendimento[kWh/kWp]} & \textbf{Eficiência[\%]} \\ \hline
Fixo & $457.813$ & $1.525,68$ & $74,90$ \\ \hline
\textit{Tracker} & $557.047$ & $1.856,46$  & $76,20$  \\ \hline

\end{tabular}
\caption{Resultados técnicos das Usinas de $300$kW}
\label{tab:rt300}
\end{table}
...
Nesta seção será feita um resumo com os principais resultados financeiros obtidos através da simulação das usinas de $300$kW de eixo fixo e móvel.
A \autoref{tab:rf300} mostra os resultados da simulação:
...
\hline
\textbf{Sistema} & \textbf{Custo de geração[R\$/kWh]} & \textbf{\textit{PayBack}[anos]]} & \textbf{\ac{TIR}[\%]} & \textbf{\ac{ROI}[\%]} \\ \hline
Fixo & $0,1622$ & $5$ anos, $11$ meses & $18,31$ & $18,31$ \\ \hline
\textit{Tracker} & $0,2133$ & $7$ anos, $8$ meses & $12,24$ & $15,06$ \\ \hline

\end{tabular}
\caption{Resultados Financeiros das Usinas de $300$kW}
\label{tab:rf300}
\end{table}
...
\subsection{Resultados técnicos}
Nesta seção será feita um resumo com os principais resultados técnicos obtidos através da simulação das usinas de $500$kW de eixo fixo e móvel.
A \autoref{tab:rt500} mostra os resultados da simulação:
...
\hline
\textbf{Sistema} & \textbf{Energia anual [kWh]} & \textbf{Rendimento[kWh/kWp]} & \textbf{Eficiência[\%]} \\ \hline
Fixo & $769.662$ & $1.539,20$ & $75,60$ \\ \hline
\textit{Tracker} & 935.237 & $1.870,36$  & $76,80$  \\ \hline

\end{tabular}
\caption{Resultados técnicos das Usinas de$ 500$kW}
\label{tab:rt500}
\end{table}
...
\subsection{Resultados Financeiros}
Nesta seção será feita um resumo com os principais resultados financeiros obtidos através da simulação das usinas de $500k$W de eixo fixo e móvel.
A \autoref{tab:rf500} mostra os resultados da simulação:
...
\hline
\textbf{Sistema} & \textbf{Custo de geração[R\$/kWh]} & \textbf{\textit{PayBack}[anos]]} & \textbf{\ac{TIR}[\%]} & \textbf{\ac{ROI}[\%]} \\ \hline
Fixo & $0,1637$ & $5$ anos, $7$ meses & $17,37$ & $19,79$ \\ \hline
\textit{Tracker} & $0,1832$ & $6$ anos, $4$ meses & $15,14$ & $17,68$ \\ \hline

\end{tabular}
\caption{Resultados Financeiros das Usinas de $500$kW}
\label{tab:rf500}
\end{table}
...
\subsection{Resultados técnicos}
Nesta seção será feita um resumo com os principais resultados técnicos obtidos através da simulação das usinas de $800$kW de eixo fixo e móvel.
A \autoref{tab:rt800} mostra os resultados da simulação:
...
\hline
\textbf{Sistema} & \textbf{Energia anual [kWh]} & \textbf{Rendimento[kWh/kWp]} & \textbf{Eficiência[\%]} \\ \hline
Fixo & $1.202.618$ & $1.538,66$ & $73,84$ \\ \hline
\textit{Tracker} & $1.498.156$ & $1.872,61$  & $76,88$ \\ \hline

\end{tabular}
\caption{Resultados técnicos das Usinas de $800$kW}
\label{tab:rt800}
\end{table}
...
Nesta seção será feita um resumo com os principais resultados financeiros obtidos através da simulação das usinas de $800$kW de eixo fixo e móvel.
A \autoref{tab:rf800} mostra os resultados da simulação:
...
\hline
\textbf{Sistema} & \textbf{Custo de geração[R\$/kWh]} & \textbf{\textit{PayBack}[anos]]} & \textbf{\ac{TIR}[\%]} & \textbf{\ac{ROI}[\%]} \\ \hline
Fixo & $0,1427$ & $5$ anos, $2$ meses & $18,97$ & $20,81$ \\ \hline
\textit{Tracker} & $0,1487$ & $5$ anos, $1$ mês  & $19,47$ & $21,79$ \\ \hline

\end{tabular}
\caption{Resultados Financeiros das Usinas de $800$kW}
\label{tab:rf800}
\end{table}
...
\hline
\textbf{Sistema} & \textbf{Energia anual [kWh]} & \textbf{Rendimento[kWh/kWp]} & \textbf{Eficiência[\%]} \\ \hline
Fixo & $1.538.740$ & $1.538,66$ & $75,60$ \\ \hline
\textit{Tracker} & $1.872.695$ & $1.872,61$  & $76,90$  \\ \hline

\end{tabular}
\caption{Resultados técnicos das Usinas de $1$MW}
\label{tab:rt1}
\end{table}
...
Nesta seção será feita um resumo com os principais resultados financeiros obtidos através da simulação das usinas de $1$MW de eixo fixo e móvel.
A \autoref{tab:rf1} mostra os resultados da simulação:
...
\hline
\textbf{Sistema} & \textbf{Custo de geração[R\$/kWh]} & \textbf{\textit{PayBack}[anos]]} & \textbf{\ac{TIR}[\%]} & \textbf{\ac{ROI}[\%]} \\ \hline
Fixo & $0,1251$ & $4$ anos, $6$ meses & $21,99$ & $23,74$ \\ \hline
\textit{Tracker} & $0,13$ & $4$ anos, $4$ meses  & $22,67$ & $24,91$ \\ \hline

\end{tabular}
\caption{Resultados Financeiros das Usinas de $1$MW}
\label{tab:rf1}
\end{table}
...
\subsubsection{Resumo Técnico das Usinas}
...
$10$ kW & Fixo & $14.523$ &  $1.376,15$ & $67,60$\% \\ \hline
$10$ kW & \textit{Tracker} & $17.746$ &  1.698,48 & 69,70\% \\ \hline
$50$ kW & Fixo & $72.251$ & $1.430,18$ &  $70,25$\% \\ \hline
$50$ kW & \textit{Tracker} & $88.295$ &  $1.751,08$ & $71,89$\%  \\ \hline
$100$ kW & Fixo & $144.501$ & $1.430,18$ & $70,25$\% \\ \hline
$100$ kW & \textit{Tracker} & $176.590$ & $1.751,0$8  & $71,89$\%  \\ \hline
$300$ kW & Fixo & $457.813$ & $1.525,68$ & $74,90$\% \\ \hline
$300$ kW & \textit{Tracker} & $557.047$ & $1.856,46$  & $76,20$\%  \\ \hline
$500$ kW & Fixo & $769.662$ & $1.539,20$ & $75,61$\% \\ \hline
$500$ kW & \textit{Tracker} & $935.237$ & $1.870,36$  & $76,80$\%  \\ \hline
$800$ kW & Fixo & $1.202.618$ & $1.538,66$ & $73,84$\% \\ \hline
$800$ kW & \textit{Tracker} & $1.498.156$ & $1.872,61$  & $76,88$\% \\ \hline
$1$ MW & Fixo & $1.538.740$ & $1.538,66$ & $75,58$\% \\ \hline

$1$ MW & \textit{Tracker} & $1.872.695$ & $1.872,61$  & $76,90$\%  \\ \hline

\end{tabular}
\caption{Resultados técnicos das Usinas }
\label{tab:resumot}
\end{table}

\subsubsection{Resumo Financeiro das Usinas}
...
$10$ kW & Fixo & $0,2198$ & $7$ anos, $10$ meses & $11,91$ & $14,26$ \\ \hline
$10$ kW & \textit{Tracker} & $0,2331$ & $8$ anos & $11,64$ & $14,52$ \\ \hline
$50$ kW & Fixo & $0,1961$ & $7$ anos, $3$ meses & $13,07$ & $15,30$ \\ \hline
$50$ kW & \textit{Tracker} & $0,2340$ &  $8$ anos, $4$ meses & $11,00$ & $13,95$ \\ \hline
$100$ kW & Fixo & $0,1846$ & $6$ anos, $9$ meses & $14,13$ & $16,26$ \\ \hline
$100$ kW & \textit{Tracker} & $0,2200$ & $7$ anos, $10$ meses  & $11,99$ & $14,83$ \\ \hline
$300$ kW & Fixo & $0,1622$ & $5$ anos, $11$ meses & $16,34$ & $18,31$ \\ \hline
$300$ kW & \textit{Tracker} & $0,2133$ & $7$ anos, $8$ meses & $12,24$ & $15,06$ \\ \hline
$500$ kW & Fixo & $0,1637$ & $5$ anos, $7$ meses & $17,37$ & $19,79$ \\ \hline
$500$ kW & \textit{Tracker} & $0,1832$ & $6$ anos, $4$ meses & $15,14$ & $17,68$ \\ \hline
$800$ kW & Fixo & $0,1427$ & $5$ anos, $2$ meses & $18,97$ & $20,81$ \\ \hline
$800$ kW & \textit{Tracker} & $0,1487$ & $5$ anos, $1$ mês  & $19,47$ & $21,79$ \\ \hline
$1$ MW & Fixo & $0,1251$ & $4$ anos, $6$ meses & $21,99$ & $23,74$ \\ \hline
$1$ MW & \textit{Tracker} & $0,1300$ & $4$ anos, $4$ meses  & $24,91$ & 24,08 \\ \hline 
...
\end{tabular}
\caption{Resultados Financeiros das Usinas}
\label{tab:resumof}
\end{table}
...
O gráfico, mostrado na \autoref{fig:img013}, exibe o ganho percentual de geração em função da potência instalada evidencia que o uso de sistemas com rastreamento solar proporciona um incremento técnico relativamente constante na geração de energia ao longo das diferentes faixas de potência analisadas. Observam-se variações pontuais no comportamento do ganho percentual, as quais podem ser atribuídas às características do modelo de simulação e às configurações elétricas adotadas, não indicando, entretanto, uma tendência de crescimento contínuo do rendimento específico com o aumento da potência instalada.

Esse comportamento reforça que o rastreamento solar não deve ser interpretado como uma tecnologia cujo benefício técnico cresce proporcionalmente com a escala do sistema, mas sim como uma solução que amplia a captação de energia ao longo do dia, resultando em um ganho energético absoluto mais significativo em sistemas de maior porte. Dessa forma, embora o ganho percentual de geração se mantenha relativamente estável, o impacto desse incremento torna-se mais relevante à medida que a potência instalada aumenta.
...
\begin{figure}[h]
	\centering
	\caption{Ganho de geração x Potencia}
	\includegraphics[width=0.8\linewidth]{./textuais/figs/ganhodegeracaoxpotencia}
    \fonteautor
	\label{fig:img013}
\end{figure}
...
\begin{figure}[h]
	\centering
	\caption{\ac{CAPEX} x Eficiência do Sistema }
...
\begin{figure}[h]
	\centering
	\caption{CAPEX x Custo de Geração de Energia }
...
\begin{figure}[h]
	\centering
	\caption{\textit{Payback} x \ac{TIR}}
