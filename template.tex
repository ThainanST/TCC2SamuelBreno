...
% tabelas
\usepackage{array} % Para maior controle sobre as tabelas
...
% ---
\titulo{Análise da viabilidade técnica e financeira sobre a utilização de sistemas fotovoltaicos fixos ou com rastreador solar}
...
\include{./pretextuais/dedicatoria}     %% Dedicatoria.

\include{./pretextuais/agradecimentos}  %% Agradecimentos.

\include{./pretextuais/epigrafe}  %% epigrafe.
...
\include{./pretextuais/acronimos}  %% Acronimos.
...
\begin{apendicesenv}
	...
	%\include{./postextuais/2apendice}
\end{apendicesenv}

%% Anexos
\begin{anexosenv}
	 %\include{./postextuais/1anexo}
	 %\include{./postextuais/2anexo}
\end{anexosenv}
